...
--changeset shadowfrog:creating_item_sale_offer

CREATE TABLE item_sale_offer(
...
CONSTRAINT chk_item_sale_count CHECK(sale_count>0),
CONSTRAINT chk_item_sale_required_items CHECK(JSONB_MATCHES_SCHEMA(
'{
"type":"array",
    "items":{
        "type":"object",
